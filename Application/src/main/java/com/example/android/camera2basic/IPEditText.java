...
//                            Toast.makeText(context, "Please enter a valid ip address",
//                                    Toast.LENGTH_LONG).show();
//                            return;
//                        }
//
...
//                        Toast.makeText(context, "Please enter a valid ip address", Toast.LENGTH_LONG)
//                                .show();
//                        return;
//                    }
//
...
//    }
    ...
    public String getText(/*Context context*/) {
        ...
        if (TextUtils.isEmpty(mText1)
                || TextUtils.isEmpty(mText2)
                || TextUtils.isEmpty(mText3)
                || TextUtils.isEmpty(mText4)) {
            Toast.makeText(context, "Please enter a valid ip address", Toast.LENGTH_LONG).show();
            return null;
        }

        if (Integer.parseInt(mText1) > 255 ||
                Integer.parseInt(mText2) > 255 ||
                Integer.parseInt(mText3) > 255 ||
